    ...
    <div class="flex min-h-screen items-center justify-center">
        ...
        <div class="min-h-1/2 bg-gray-900  border border-gray-900 rounded-2xl">
            ...
            <div class="mx-4 sm:mx-24 md:mx-34 lg:mx-56 mx-auto  flex items-center space-y-4 py-16 font-semibold text-gray-500 flex-col">
                ...
                <h1 class="text-white text-2xl">Login to chwitter</h1>
                <input class="w-full p-2 bg-gray-900 rounded-md  border border-gray-700 focus:border-blue-700" placeholder="Username" type="email" name="email" id=""/>
                <input class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 " placeholder="Password" type="password" name="password" id=""/>
